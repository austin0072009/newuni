	...
	<view>
		<view class="auth">
			<view class="wanl-title">
				<view> {{userInfo.nickName}}，{{$t('login.msg46')}}</view>  
				<view class="titleInfo"> {{$t('login.msg47')}}</view>
			</view>
			<form @submit="formSubmit">
				...
				<view class="auth-button flex flex-direction">
					<button class="cu-btn bg-orange sl radius-bock" form-type="submit" :disabled="submitDisabled">{{$t('login.msg32')}}</button>
				</view>
			</form>
		</view>
