		...
		<view class="wanl-direct">
			...
			<view class="menu-box">
				...
				<view class="menu-item" hover-class="wanl-opcity" @tap="$wanlshop.on('/pages/user')">
					...
					<view class="menu-text">{{$t('index.mine')}}</view>
				</view>
