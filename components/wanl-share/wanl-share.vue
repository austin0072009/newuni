<template>
	<view>
		<view class="wanl-share">
			<view class="head">
				<view class="content"><view class="text-lg">{{$t('gg.share_msg1')}}</view></view>
			</view>
			<scroll-view class="scroll-x solid-bottom" scroll-x="true" show-scrollbar="false" :scroll-left="scrollAnimation" scroll-with-animation>
				...
				<view class="scroll-item">
					<button open-type="share">
						...
						<view class="project text-sm"><text>{{$t('gg.msg10')}}</text></view>
					</button>
				</view>
				<!-- #endif -->
			...
			<view class="footer" @tap="close"><text>{{$t('gg.msg11')}}</text></view>
		</view>
	</view>
</template>
